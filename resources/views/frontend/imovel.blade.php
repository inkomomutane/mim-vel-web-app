                    ...
                    <div class="item">
                        <div class="clearfix" style="width: 755px" >
                            <ul id="image-gallery" class="gallery list-unstyled cS-hidden">
                                <li data-thumb="{{ asset('storage/imoveis/sd_dft_gg_task.png') }}">
                                    <img src="{{ asset('storage/imoveis/sd_dft_gg_task.png') }}">
                                </li>
                                <li data-thumb="{{ asset('storage/imoveis/sd_dft_gg_task.png') }}">
                                    <img src="{{ asset('storage/imoveis/sd_dft_gg_task.png') }}">
                                </li>
                                ...
                                <li data-thumb="{{ asset('storage/imoveis/sd_dft_gg_task.png') }}">
                                    <img src="{{ asset('storage/imoveis/sd_dft_gg_task.png') }}">
                                </li><li data-thumb="{{ asset('storage/imoveis/sd_dft_gg_task.png') }}">
                                    <img src="{{ asset('storage/imoveis/sd_dft_gg_task.png') }}">
                                </li>
                                <li data-thumb="{{ asset('storage/imoveis/sd_dft_gg_task.png') }}">
                                    <img src="{{ asset('storage/imoveis/sd_dft_gg_task.png') }}">
