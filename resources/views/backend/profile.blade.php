    ...
    <div class="row container py-2">
        <div class="card profile-widget">
            <div class="profile-widget-header">
                <img alt="image" src="{{ asset('/backend/images/avatar.png') }}" class="rounded-circle profile-widget-picture">
            ...
            <div class="profile-widget-description pb-0">
                <div class="profile-widget-name">{{$user->name}} <div class="text-muted d-inline font-weight-normal"><div class="slash"></div>Corretor</div></div>
