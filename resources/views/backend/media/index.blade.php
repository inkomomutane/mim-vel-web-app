                            ...
                            <div class="dropdown position-relative">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a class="dropdown-item"
                                        href="{{ route('posts.show', $image->model->slug) }}">Post</a>

                                    <a class="dropdown-item" href="#"
                                        onclick="document.getElementById('image_{{ $image->id }}').submit()">
                                        <form action="{{ route('media.destroy', ['media' => $image->id]) }}" method="post"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Novas Imagens</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('media.store', ['imovel' => $imovel->slug]) }}" method="post"
