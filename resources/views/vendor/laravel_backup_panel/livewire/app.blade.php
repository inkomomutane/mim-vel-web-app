            ...
            <div class="card shadow-sm mb-4">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tr>
                        ...
                        <th scope="col">Número de backups</th>
                        <th scope="col">Novos backups</th>
                        <th scope="col">Armazenamento usado</th>
                    </tr>
                    </thead>
                    <tbody>
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <span class="text-muted">
                                    Tem certeza que deseja <strong>remover</strong> o backup criado em {{ $deletingFile['date'] }} ?
                                </span>
                                @endif
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-danger delete-button" wire:click="deleteFile">Remover</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('livewire:load', function () {
            ...
            const backupFun = function (option = '') {
                Toastify({
                    text: 'Criando o backup...' + (option ? ' (' + option + ')' : ''),
                    duration: 5000,
                    gravity: 'bottom',
                    position: 'right',
