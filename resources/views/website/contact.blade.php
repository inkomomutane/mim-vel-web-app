...
@section('content')
        ...
        <section
            class="relative z-10 overflow-hidden bg-slate-50 "
        >
            <div class="container mx-auto">
                <div class="-mx-4 flex lg:justify-items-center pt-16">
                    <div class="w-full">
                        <div
                            class="mb-8  lg:mb-0 text-center md:text-left"
                        >
                            <h1
                                class="text-orange-400 my-6 text-[32px] text-center font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                            >
                                Entre em contacto
                            </h1>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  justify-items-center">
                                <div class="mb-8 flex w-full max-w-[370px]">
                                    <div
                                        class="bg-orange-400 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                                    >
                                        <svg
                                            width="24"
                                            height="24"
                                    ...
                                    <div class="w-full">
                                        <h4
                                            class="text-orange-400 mb-1 text-xl font-bold"
                                        >
                                            Localização
                                        </h4>
                                ...
                                <div class="mb-8 flex w-full max-w-[370px]">
                                    <div
                                        class="bg-orange-500 text-orange-400 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                                    >
                                        <svg
                                            width="24"
                                            height="26"
                                ...
                                <div class="mb-8 flex w-full max-w-[370px]">
                                    <div
                                        class="bg-orange-400 text-orange-400 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                                    >
                                        <svg
                                            width="28"
                                            height="19"
                            ...
                            <div class="grid gap-2 gap-y-2 text-sm grid-cols-1 md:grid-cols-2">
                              ...
                              <div class="md:col-span-2 text-right">
                                <div class="inline-flex items-end">
                                  <button class="bg-orange-400 hover:bg-orange-500 text-white font-bold py-2 px-4 rounded">Enviar mensagem</button>
                                </div>
                              </div>
