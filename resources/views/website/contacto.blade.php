...
@section('content')
    ...
    <section class="">
        <div class="container-fluid mt-4 pt-5 d-table">
            <div class="row justify-content-center bg-facebook-darken">
                ...
                <!--end col-->
                <nav aria-label="breadcrumb" class="d-inline-block col-6 col-md-3 bg-facebook-darken" style="margin-top: -1.3rem">
    ...
    <section class="section pb-0 bg-facebook-darken">
        <div class="container">
            <div class="row">
                <div class=" col-sm-12 col-md-4">
                    <div class="card border-0 text-center features feature-clean p-5">
                ...
                <div class=" col-sm-12 col-md-4 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="card border-0 text-center features feature-clean p-5">
                        ...
                        <div class="content mt-3">
                            ...
                            <p class="text-muted">Envie - nos sua mensagem a qualquer hora!</p>
        ...
        <div class="container mt-100 mt-60 mb-0">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6 pt-2 pt-sm-0 order-1 order-md-2 p-5">
