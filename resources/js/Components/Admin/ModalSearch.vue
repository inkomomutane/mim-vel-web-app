<template>
    ...
    >
        ...
        >
            <div
                ref="modalContent"
                class="bg-white dark:bg-slate-800 overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg"
            >
                <!-- Search form -->
                <form class="border-b border-gray-200 dark:border-gray-700">
                    <div class="relative">
                        ...
                        <input
                            :id="searchId"
                            class="w-full dark:bg-slate-800 dark:text-gray-400 border-0 focus:ring-transparent placeholder-gray-400 appearance-none py-3 pl-10 pr-4"
                            type="search"
                ...
                <div class="py-4 px-2">
                    ...
                    <div class="mb-3 last:mb-0">
                        ...
                        <ul class="text-sm">
                            <li>
                                <Link
                                    class="flex items-center p-2 text-gray-800 dark:text-gray-100 hover:text-white hover:bg-indigo-500 rounded group"
                                    href="#0"
                        ...
                        <ul class="text-sm">
                            <li>
                                ...
                                >
                                    ...
                                    <span
                                        ><span
                                            class="font-medium text-gray-800 dark:text-gray-100 group-hover:text-white"
                                            >Messages</span
                                        >
