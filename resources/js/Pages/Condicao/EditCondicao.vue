...
const props = defineProps({
    condicao: {
        type: Object as PropType<App.Data.CondicaoData>,
        required: true,
    },
    close: {
        type: Function,
...
const nomeInput = ref<String | any>(props.condicao.nome);

const form = useForm({
    id: props.condicao.id,
    nome: props.condicao.nome,
});

const updateCondicao = () => {
    form.patch(
        route("condicao.update", {
            condicao: props.condicao.id as number,
        }),
        {
            preserveScroll: true,
            onSuccess: () => {
    ...
    <Modal :show="props.openModal" @close="props.close">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                >
                    Editar condição do imóvel
                </h3>
                <form class="space-y-6" @submit.prevent="updateCondicao">
                    <div>
                        <label
                            for="nome"
