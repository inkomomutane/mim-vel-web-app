...
const props = defineProps({
    negocio: {
        type: Object as PropType<App.Data.RegraDeNegocioData>,
        required: true,
    },
    close: {
        type: Function,
...
const deleteNegocio = () => {
    form.delete(
        route("negocio.delete", {
            regraDeNegocio: props.negocio.id as number,
        }),
        {
            preserveScroll: true,
            onSuccess: () => {
    ...
    <Modal :show="props.openModal" @close="props.close">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                <h3
                    class="mb-4 text-md font-medium text-gray-900 dark:text-white line-clamp-2"
                >
                    Tem certeza que quer excluir essa regra de negóciação?
                </h3>
                <form class="space-y-6" @submit.prevent="deleteNegocio">
                    <button
                        type="submit"
