...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex flex-col md:flex-row items-center justify-end space-b-3 md:space-y-0 md:space-x-4 p-4">
            <button
    ...
    <svg  xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 16 16" fill="currentColor">
        ...
        <div class="p-8 bg-white rounded overflow-auto dark:bg-slate-700 dark:text-slate-50">
            {{ form.errors.politicas }}
            <ckeditor class="border-none shadow-none shadow-transparent" :editor="BalloonEditor" v-model="form.politicas" :config="{}"></ckeditor>
        </div>
        </template>
    </AuthenticatedLayout>
</template>
