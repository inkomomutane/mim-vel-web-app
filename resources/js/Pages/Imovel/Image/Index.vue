...
const links = ref(props.images?.links);
const deletingImageTrigger = ref(false);
const deletingImage = ref<App.Data.MediaData | null>(null);
    ...
    <AuthenticatedLayout>
        <template v-slot:content>
            ...
            >
                <div
                    class="mx-4"
                    v-for="media in props.images?.data"
            ...
            >
                ...
                >
                    ...
                    <span class="font-semibold text-gray-900 dark:text-white">{{
                        `${images?.meta.from ?? 0}-${images?.meta.to ?? 0}`
                    }}</span>
                    of
                    <span class="font-semibold text-gray-900 dark:text-white">
                        {{ images?.meta.total }}</span
                    >
                </span>
