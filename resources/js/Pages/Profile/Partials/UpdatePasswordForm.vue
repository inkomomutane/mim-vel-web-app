        ...
        <form class="mt-6 gap-6 grid grid-cols-1 md:grid-cols-3">
            ...
            <div class="flex items-center gap-4">
                <button
                    ...
                    class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-sm text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-600 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
