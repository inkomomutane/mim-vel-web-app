...
<template>
    <GuestLayout>
        ...
        <section
            class="relative z-10 overflow-hidden bg-slate-50 p-10 md:p-36 lg:py-[120px]"
        >
            <div class="container mx-auto">
                <div class="-mx-4 flex flex-wrap lg:justify-between">
                    <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                        <div
                            class="mb-12 max-w-[570px] lg:mb-0 text-center md:text-left"
                        >
                            <span
                            ...
                            <div class="mb-8 flex w-full max-w-[370px]">
                                ...
                                <div class="w-full">
                                    <h4
                                        class="text-dark mb-1 text-xl font-bold"
                                    >
                                        Our Location
                                    </h4>
                    ...
                    <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <span
                                    class="absolute -right-10 top-[90px] z-[-1]"
                                >
                                    <svg
                                        width="34"
                                        height="134"
