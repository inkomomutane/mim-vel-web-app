            ...
            >
                ...
                <div class="grid grid-cols-1 gap-2 py-2">
                    <div
                        ...
                        class="rounded-[2px] mb-2 flex flex-col bg-slate-50"
                    >
                        <div class="flex gap-2 my-2">
                            ...
                            <h2
                                class="p-1 text-sm bg-green-500 w-fit rounded-sm font-semibold text-white px-4"
                            >
                                Preço: {{ room.price }}
                            </h2>
                        </div>
                        <div
                            class="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-4 gap-3 gap-x-8"
                        >
                            <div
                                v-for="(file, index) in room.images"
                                class="grid grid-cols-3 md:grid-cols-4 items-center content-between space-x-4 w-full bg-red-200 dark:bg-slate-800 pr-2 py-0.5"
                            >
                                ...
                                <div
                                    class="flex-1 sm:block sm:max-w-full md:col-span-2"
                                >
                                    <p
