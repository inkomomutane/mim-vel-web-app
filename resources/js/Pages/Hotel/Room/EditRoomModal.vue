...
const createRoom = () => {
        return form.post(route('hotel.rooms.update.new-room',{
            hotel : props.hotel?.id as number
        }))
}
</script>
            ...
            <div class="px-6 py-6 pb-2  lg:px-8">
                ...
                <div class="space-y-2" >
                    ...
                    <div>
                        ...
                        <li v-for="image in hotel.images" class="rounded border border-dashed border-green-700 bg-green-100 dark:bg-green-950 flex flex-wrap p-0 mb-4 gap-0 w-full"><div class="flex items-center space-x-4 w-full"><div class="flex-shrink-0">

                            <ResponsiveImage :responsive="image" class-name="w-[100px] shadow-2 h-16 object-cover"  />

                        </div>
                            <div class="flex-1 hidden sm:block sm:w-64"
                        ><p class="text-sm font-medium text-justify text-gray-900 truncate dark:text-white">{{  image.name }}</p>
                        </div>
                            <div class="flex-1 min-w-fit"><p class="text-sm font-medium text-gray-900 truncate dark:text-white">{{ image.size }} KB</p>
                            </div><div class="flex-1 min-w-0"></div>

                            <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                <div role="status">
                                    <svg class="w-6 h-6 mr-2 text-gray-200 dark:text-green-50 fill-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M17.3 6.3c-.39-.39-1.02-.39-1.41 0l-5.64 5.64 1.41 1.41L17.3 7.7c.38-.38.38-1.02 0-1.4zm4.24-.01l-9.88 9.88-3.48-3.47c-.39-.39-1.02-.39-1.41 0-.39.39-.39 1.02 0 1.41l4.18 4.18c.39.39 1.02.39 1.41 0L22.95 7.71c.39-.39.39-1.02 0-1.41h-.01c-.38-.4-1.01-.4-1.4-.01zM1.12 14.12L5.3 18.3c.39.39 1.02.39 1.41 0l.7-.7-4.88-4.9c-.39-.39-1.02-.39-1.41 0-.39.39-.39 1.03 0 1.42z"></path></svg>
                                    <span class="sr-only">Done</span>
                                </div>
                            </div>
                            <button class="px-4"><svg aria-hidden="true" class="w-5 h-5 text-gray-500 hover:text-red-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                            </button>
                        </div>
                        </li>
                        </ul>
