...
const form = useForm({
    ...
    slug_text: props.transactionType.slug_text,
});

const deleteTransactionType = () => {
    form.delete(
        route("transaction.type.delete", {
            transactionType: props.transactionType.id as number,
        }),
        {
            preserveScroll: true,
            onSuccess: () => {
    ...
    <Modal :show="props.openModal" @close="props.close">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                >
                    Tem certeza que quer excluir esse tipo de transação?
                </h3>
                <form class="space-y-6" @submit.prevent="deleteTransactionType">
                    <button
                        type="submit"
