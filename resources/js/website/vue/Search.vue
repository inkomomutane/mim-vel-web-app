...
<template>
    <div class="flex items-center p-6 space-x-6 mt-8 bg-gray-50  shadow-lg hover:shadow-xl
     transform hover:scale-105 transition duration-500">
        ...
        <input @focus="openModal" type="search" id="default-search" class="block w-full p-3 pl-10 text-sm text-gray-900 border
        ring-0 focus:ring-0
         border-gray-300 rounded-sm bg-gray-200 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700
          dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Search Mockups, Logos..." required>
    </div>
     </div>
    ...
    <!-- Button to open modal -->
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button @click="closeModal" type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="crypto-modal">
