...
<template>
    <div>
        ...
        <ul
            class="grid grid-cols-1 grid-rows-none gap-4 overflow-auto md:grid-cols-2 md:grid-rows-3 lg:gap-4 xl:max-h-[56rem] xl:grid-rows-2"
        >
            <li
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div
                                class="w-fit rounded-lg border border-gray-600 p-2"
                            >
                                <Icon
