...
<template>
    <div id="pricing-plans">
        <h2 class="my-4 text-center text-4xl font-black">
        ...
        <div
            class="mt-8 flex flex-col items-center justify-center gap-4 lg:flex-row lg:items-start"
        >
            <Card
                v-for="plan in plans"
                :key="plan.id"
            ...
            >
                <h3 class="text-center text-xl font-black">
                    {{ plan.title }}
                </h3>
                ...
                <div class="items-top my-2 flex justify-center">
