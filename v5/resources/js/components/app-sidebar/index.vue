...
<template>
    <Sidebar collapsible="icon" class="z-50">
        <SidebarHeader
            class="flex h-14 w-full items-center border-b p-2 group-data-[collapsible=icon]:justify-center"
        >
            <div
                type="button"
                class="flex h-full w-full items-center gap-2 rounded"
            >
                <div
                    class="flex aspect-square size-8 shrink-0 items-center justify-center"
                >
                    <img
                        v-if="app.image"
                        :src="app.image"
