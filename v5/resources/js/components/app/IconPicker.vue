    ...
    <Popover v-model:open="open">
        ...
        >
            ...
            >
                ...
                <div
                    v-else
                    class="grid grid-cols-5 gap-1 p-2"
                >
                    <button
                        v-for="icon in icons"
                    ...
                    >
                        ...
                        <Badge
                            ...
                            "
                            variant="secondary"
                            class="absolute right-1 top-1 px-1 py-0 text-[8px]"
                        >
                            Lab
                        </Badge>
                        ...
                        <Check
                            v-if="
                                ...
                                icon.id
                            "
                            class="absolute left-1 top-1 size-3"
                        />
                    </button>
                </div>
