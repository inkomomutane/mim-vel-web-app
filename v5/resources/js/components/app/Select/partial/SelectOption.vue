...
<template>
    <div
      ...
      cn(
        ...
        ['hover:bg-zinc-100 dark:hover:bg-zinc-800', 'focus:bg-zinc-100 dark:focus:bg-background'],
        {
          'border-zinc-600 bg-background dark:border-white': props.selected,
          'hover:bg-background': props.selected,
          'focus:bg-background': props.selected,
          'border-transparent': !props.selected,
        },
        ['!min-w-72', 'border-b border-b-gray-200/80 dark:border-b-zinc-900/90'],
        props.class,
      )
    "
    >
