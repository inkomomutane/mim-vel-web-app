...
defineProps({
    image: {
        type: Object as PropType<App.Data.MediaData> | undefined | null,
    },
});
</script>

<template>
    <ul v-if="image" class="max-h-96 overflow-y-auto">
        <li
            class="rounded border border-dashed border-green-700 bg-green-100 dark:bg-green-950 flex flex-wrap p-0 my-4 gap-0 w-full"
        >
            <div class="flex items-center space-x-4 w-full">
                ...
                >
                    <div
                        class="px-6 inline-flex items-center text-base font-semibold text-gray-900 dark:text-white"
                    >
                        <div
                            role="status"
                            class="bg-green-400 rounded-full p-1"
                        >
                            <svg
