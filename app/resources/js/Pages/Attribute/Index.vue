...
import DeleteAttribute from "./DeleteAttribute.vue";
...
const links = ref(props.attributes.links);

const editingAttributeTrigger = ref(false);
const editingAttribute = ref<App.Data.AttributeData | null>(null);

const deletingAttributeTrigger = ref(false);
const deletingAttribute = ref<App.Data.AttributeData | null>(null);
...
function openEditAttributeModal(attribute: App.Data.AttributeData) {
    editingAttribute.value = attribute;
    editingAttributeTrigger.value = true;
}

function closeEditAttributeModal() {
    editingAttribute.value = null;
    editingAttributeTrigger.value = false;
}

function openDeleteAttributeModal(attribute: App.Data.AttributeData) {
    deletingAttribute.value = attribute;
    deletingAttributeTrigger.value = true;
}

function closeDeleteAttributeModal() {
    deletingAttribute.value = null;
    deletingAttributeTrigger.value = false;
}
</script>
    ...
    <AuthenticatedLayout>
        <template v-slot:content>
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                ...
                                >{{
                                    `${attributes.meta.from ?? 0}-${
                                        attributes.meta.to ?? 0
                                    }`
                                }}</span
                            >
                            of
            ...
            <EditAttribute
                ...
                :openModal="editingAttributeTrigger"
                :close="closeEditAttributeModal"
            />
            <DeleteAttribute
                v-if="deletingAttribute"
                :attribute="deletingAttribute"
                :openModal="deletingAttributeTrigger"
                :close="closeDeleteAttributeModal"
            />
        </template>
    </AuthenticatedLayout>
</template>
