...
const deleteIntermediation = () => {
    form.delete(
        route("intermediation.delete", {
    ...
    <Modal :show="props.openModal" @close="props.close">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                >
                    Tem certeza que quer excluir essa regra de intermediação?
                </h3>
                <form class="space-y-6" @submit.prevent="deleteIntermediation">
                    <button
                        type="submit"
